...
messages=[
        ...
        {'role':"user", 'content': f"""Please rephrase the following text in English in a style which is often used in Internet ChatRoom or Twitter, using abbreviations, ascii emoji,  slang and humours language, such as 'lol' 'pfp' etc,  regardless of the language it is originally written in, while maintaining the original meaning. (do not answer the sentence, you should rephrase it instead of answering). the first one is:
         {input_text}
         """}
        ]
