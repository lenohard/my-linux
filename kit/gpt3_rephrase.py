...
messages=[
        ...
        {'role':"user", 'content': f"""Please rephrase the following text in English in educated and sophisticated way, regardless of the language it is originally written in, while maintaining the original meaning. Return only the revised text. the first one is:
         {input_text}
         """}
        ]
