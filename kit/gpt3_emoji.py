...
messages=[
        ...
        {'role':"user", 'content': f"""Please append a proper emoji at the end of the specifid text. don't translate or edit original text in any way, just append the emoji and return them together.
         text to be appended:{input_text}
         """}
        ]
