...
messages=[
        ...
        {'role':"user", 'content': f"""Please correct and edit the following text to create a improved version in Japanese, regardless of the language it is originally written in, while maintaining the original meaning.
        Return only the revised text.
        The first text I provide is:
         {input_text} """
         }
        ]
